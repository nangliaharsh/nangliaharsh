...
- ##MindfulChat — AI Wellness Companion** 
- A responsible AI engineering system for mental wellness utilizing React, FastAPI, Groq/Llama 3, ChromaDB, and `sentence-transformers` (deployed on Vercel + Render).
